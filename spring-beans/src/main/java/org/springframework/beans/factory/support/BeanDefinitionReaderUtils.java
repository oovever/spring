...
public abstract class BeanDefinitionReaderUtils {
	...
	public static void registerBeanDefinition(
		...
		String beanName = definitionHolder.getBeanName(); // 获取bean名称
		registry.registerBeanDefinition(beanName, definitionHolder.getBeanDefinition()); // 注册beanDefinition到beanDefinitionMap中

		// Register aliases for bean name, if any.
		String[] aliases = definitionHolder.getAliases();
		if (aliases != null) {
			for (String alias : aliases) {
				registry.registerAlias(beanName, alias); // 注册记录bean名称与别名关系
			}
		}
	}
