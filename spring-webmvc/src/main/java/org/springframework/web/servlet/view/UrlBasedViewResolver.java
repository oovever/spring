...
public class UrlBasedViewResolver extends AbstractCachingViewResolver implements Ordered {
	...
	protected View createView(String viewName, Locale locale) throws Exception {
		...
		if (!canHandle(viewName, locale)) { // 视图解析器无法解析视图直接返回null
			return null;
		}

		// Check for special "redirect:" prefix. 		// 处理前缀为  "redirect:" (重定向)的情况
		...
		// Check for special "forward:" prefix. // 处理前缀为  "forward:" 的情况
		...
		return super.createView(viewName, locale); // 调用父类创建视图
	}
	...
	protected View loadView(String viewName, Locale locale) throws Exception {
		AbstractUrlBasedView view = buildView(viewName); // 创建视图
	...
	protected AbstractUrlBasedView buildView(String viewName) throws Exception {
		...
		view.setUrl(getPrefix() + viewName + getSuffix()); // 视图URL加前缀和后缀
