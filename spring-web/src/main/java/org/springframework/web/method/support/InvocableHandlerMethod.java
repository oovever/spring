...
public class InvocableHandlerMethod extends HandlerMethod {
	...
	public Object invokeForRequest(NativeWebRequest request, @Nullable ModelAndViewContainer mavContainer,
		...
		Object[] args = getMethodArgumentValues(request, mavContainer, providedArgs); // 获取目标方法请求参数
		if (logger.isTraceEnabled()) {
			logger.trace("Arguments: " + Arrays.toString(args));
		}
		return doInvoke(args); // 反射调用执行
	}
	...
	protected Object[] getMethodArgumentValues(NativeWebRequest request, @Nullable ModelAndViewContainer mavContainer,
		...
		if (ObjectUtils.isEmpty(parameters)) { //参数为空直接返回
			return EMPTY_ARGS;
		}

		Object[] args = new Object[parameters.length]; // 构建参数数组
	...
	protected Object doInvoke(Object... args) throws Exception {
		Method method = getBridgedMethod(); // 获取目标方法
		try {
