...
class ConfigurationClassEnhancer {
	...
	private static class BeanMethodInterceptor implements MethodInterceptor, ConditionalCallback {
		...
		public Object intercept(Object enhancedConfigInstance, Method beanMethod, Object[] beanMethodArgs,
			...
			String beanName = BeanAnnotationHelper.determineBeanNameFor(beanMethod); // 获取bean名称
			...
			if (isCurrentlyInvokedFactoryMethod(beanMethod)) { // 代理的要执行的方法，是否为创建bean的方法，
			...
			return resolveBeanReference(beanMethod, beanMethodArgs, beanFactory, beanName); // 代理的要执行的方法，不是为创建bean的方法，根据方法名字从spring获取
		}
